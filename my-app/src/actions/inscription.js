 ...
 * @param {Number} zip_code le zip_code de connection
 * @param {String} region le zip_code de connection
 * @param {String} path le urlimage de connection
 * @returns
 */
export const actionSaveUser = (last_name, first_name, email, pseudo, address, zip_code,region, path ) => ({
  type: SAVE_USER,
  payload: {
    last_name, first_name, email, pseudo, address, zip_code,region, path
  },
});
